  ...
  return (
    <div className="mx-auto max-w-5xl">
      ...
      <form onSubmit={handleSubmit(submit)} className="space-y-6">
        ...
        <section className="space-y-4 rounded-xl border border-border bg-card p-5">
          <div><h3 className="font-semibold">SEO</h3><p className="text-sm text-muted-foreground">Set the search title, summary, page heading, and canonical path before publication.</p></div>
