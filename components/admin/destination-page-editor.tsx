...
function initialForm(initialPage?: AdminDestinationPage): SaveAdminDestinationPageInput {
  if (initialPage) return {
    ...
    address: initialPage.address, latitude: initialPage.latitude, longitude: initialPage.longitude, terminals: initialPage.terminals,
  ...
  return { slug: "", officialName: "", displayName: "", iataCode: "", serviceArea: "", googlePlaceId: "", address: "", latitude: 0, longitude: 0, terminals: [emptyTerminal()], content: normalizeDestinationContent(undefined, "Airport Taxi & Transfers") }
}
